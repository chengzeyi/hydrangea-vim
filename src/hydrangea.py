...
color['FoldColumn']   = {'fg': blue1,            'bg': base02,                'deco': 'NONE'     }
color['SpecialKey']   = {'fg': base00,           'bg': 'NONE',                'deco': 'bold'     }
...
color['Operator']     = {'fg': magenta1,                                      'deco': 'bold'     }
color['Include']      = {'fg': violet1,                                       'deco': 'NONE'     }
color['PreProc']      = {'fg': violet2,                                       'deco': 'NONE'     }
color['Type']         = {'fg': magenta1,                                      'deco': 'bold'     }
color['StorageClass'] = {'fg': blue1,                                         'deco': 'bold'     }
color['Structure']    = {'fg': magenta1,                                      'deco': 'bold'     }
