...
hi CursorLine ctermfg=NONE ctermbg=234 cterm=bold guifg=NONE guibg=#1e222c gui=bold
...
hi VertSplit ctermfg=234 ctermbg=234 cterm=NONE guifg=#1e222c guibg=#1e222c gui=NONE
